...
// const pluckedArray = _.pluck(myObjectArray, 'address');
...
// (the two owners from our lists) and each property is an array of that person's
// purchases.
...
console.log(purchasesByMonth); // Use groupBy to group the purchases by the month that they were made.

// Bonus Points
//const totalByMonth = _.groupBy(purchasesByMonth).reduce();
const totalByMonth = _.reduce((purchasesByMonth, price) => price);
console.log(totalByMonth); // Use the groupded purchasesByMonth and reduce to create a totalByMonth object.
